        ...
        <Card className="shadow-xl border-0 bg-white/90 backdrop-blur">
          ...
          <CardContent className="space-y-6 pb-8">
            <Button 
              ...
              className="w-full bg-red-500 hover:bg-red-600 text-white py-6 text-base font-medium rounded-xl shadow-lg hover:shadow-xl transition-all duration-200 flex items-center justify-center space-x-3"
            >
